...
public class MinhaListaIntegracaoTest {
	...
	private <Tipo> MinhaListaReversivelImp<Tipo> criarMinhaLista() {

		MinhaListaReversivelImp<Tipo> resultado = null;

		resultado = new MinhaListaReversivelImp<Tipo>();
	...
	public void testSufixarMuitos() {
		...
		MinhaListaReversivelImp<String> obj = null;
		String str = null;
		String valor = null;
	...
	private <Tipo> Tipo buscarPrefixo(MinhaListaReversivelImp<Tipo> lista) {
	...
	private <Tipo> void adicionarElementos(
			MinhaListaReversivelImp<Tipo> lista, 
			int quantidade) {

		Tipo[] valores = null;

		valores = (Tipo[]) new Object[quantidade];
	...
	private MinhaListaReversivelImp<String> criarMinhaListaDeStringComPrefixo(
			String prefixo, int quantidade) {

		MinhaListaReversivelImp<String> resultado = null;
		String[] valores = null;
	...
	private <Tipo> boolean existeValorNaLista(MinhaListaReversivelImp<Tipo> lista, Tipo valor) {

		boolean resultado = false;
		Tipo valorAtual = null;
